...
export interface ElectronAPI {
  ...
  gitUnstage: (repoPath: string, filePaths: string[]) => Promise<{ success: boolean } | { error: string }>
  gitDiscard: (repoPath: string, filePaths: string[]) => Promise<{ success: boolean } | { error: string }>
  ...
  gitBranchMerge: (repoPath: string, name: string) => Promise<{ success: boolean } | { error: string }>
  gitBranchDelete: (repoPath: string, name: string, force?: boolean) => Promise<{ success: boolean } | { error: string }>
  gitLog: (repoPath: string, maxCount?: number) => Promise<{ commits: GitCommit[] } | { error: string }>
  // Terminal
...
const api: ElectronAPI = {
  ...
  gitBranchMerge: (repoPath, name) => ipcRenderer.invoke('git:branchMerge', repoPath, name),
  gitBranchDelete: (repoPath, name, force) => ipcRenderer.invoke('git:branchDelete', repoPath, name, force),
